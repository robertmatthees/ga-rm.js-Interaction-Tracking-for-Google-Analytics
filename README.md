...
<code>min_itimme:10</code> - Min. Interaction Time from when Element gets tracked <i>(integer: in Seconds &gt; 0 | default: 0.1)</i>
...
- Add generic "time on page" tracker (init option) for more accurate tracking in Google Analytics
